export default function Home() {
  return (
    <div className="w-full">
      ...
      {/* بخش گالری نمونه‌کارها (Placeholder برای پروژه‌ها) */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div className="bg-slate-900 rounded-xl overflow-hidden border border-slate-800 group">
              <div className="h-64 bg-slate-800 flex items-center justify-center text-slate-500 group-hover:bg-slate-700/50 transition-all relative">
                <span className="text-xs uppercase tracking-widest text-slate-400">رندر آشپزخانه مدرن (کابینت ۲۱)</span>
              </div>
              <div className="p-5">
            ...
            <div className="bg-slate-900 rounded-xl overflow-hidden border border-slate-800 group">
              <div className="h-64 bg-slate-800 flex items-center justify-center text-slate-500 group-hover:bg-slate-700/50 transition-all relative">
                <span className="text-xs uppercase tracking-widest text-slate-400">رندر آشپزخانه نئوکلاسیک (Cabinet 21)</span>
              </div>
              <div className="p-5">
            ...
            <div className="bg-slate-900 rounded-xl overflow-hidden border border-slate-800 group">
              <div className="h-64 bg-slate-800 flex items-center justify-center text-slate-500 group-hover:bg-slate-700/50 transition-all relative">
                <span className="text-xs uppercase tracking-widest text-slate-400">رندر کلوزت‌روم و کمد دیواری</span>
              </div>
              <div className="p-5">
